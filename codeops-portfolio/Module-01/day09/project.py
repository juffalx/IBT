...
class Branch:
    ...
    # this go every child branch and sum all money
...
region1 = Branch("North")
region2 = Branch("South")
...
branch1.add_account(acc_1)
branch2.add_account(acc_2)
branch3.add_account(acc_3)
...
transfers = {
    acc_1.account_number: [acc_2.account_number],
    acc_2.account_number: [acc_3.account_number],
    acc_3.account_number: []
}
...
print("reachable account")
print(bfs(transfers, acc_1.account_number))